...
@Configuration
public class KafkaPeriodicService {
    Logger LOG = LoggerFactory.getLogger(KafkaPeriodicService.class);
    ...
    @Autowired
    public KafkaPeriodicService(KafkaTemplate<Long, Call> kafkaCallTemplate,
